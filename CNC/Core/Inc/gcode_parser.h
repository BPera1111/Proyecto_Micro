...
// void moveAxes(float x, float y, float z);  // No usada en la versión simplificada
void performHoming(void);
// void showConfiguration(void);  // No usada
// void sendUSBMessage(const uint8_t* data, uint16_t length);  // No usada

// Callbacks activos para el planner
// void moveAxesCallback(float x, float y, float z, bool x_defined, bool y_defined, bool z_defined);  // No usada
...
// void setPositionCallback(float x, float y, float z, bool x_defined, bool y_defined, bool z_defined);  // No usada
// void performHomingCallback(void);  // No usada
